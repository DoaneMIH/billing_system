...
if (strlen($query) > 0) {
    ...
    $sql .= " AND (c.account_number LIKE '$search_term' OR c.subscriber_name LIKE '$search_term' OR c.address LIKE '$search_term' OR c.tel_no LIKE '$search_term' OR c.account_name LIKE '$search_term')";
}
